...
# ========================
# DÜZELTİLMİŞ YEDEKLEME KOMUTU (ÇALIŞIYOR)
# ========================
        ...
        for kanal_verisi in yedek["kanallar"]:
            try:
                if kanal_verisi["tip"] == "text":
                    await ctx.guild.create_text_channel(kanal_verisi["isim"])
                elif kanal_verisi["tip"] == "voice":
                    await ctx.guild.create_voice_channel(kanal_verisi["isim"])
                elif kanal_verisi["tip"] == "category":
                    await ctx.guild.create_category(kanal_verisi["isim"])
            except:
                pass
...
# ========================
# DİĞER KOMUTLAR (EĞLENCE, MEDYA, OYUNLAR)
# ========================
...
# ========================
# EĞLENCE KOMUTLARI (Kısa Versiyon)
# ========================
